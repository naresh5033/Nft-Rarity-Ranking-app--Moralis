  ...
  return (
    <>
      ...
      <div className="homeList">
        ...
        {collections?.map((e,i)=>{
          return ( // lets map thru each the collections and for each collection return a card with the onclick nav to the the corresponding contract addr(from the collections.js)
            <Card
              key={i}
              hoverable
              style={{ width: 250 }}
